...
const Sidebar = () => {
  ...
  return (
    <div className="shadow-lg  md:w-48 ">
      <ul className="sm:pt-2">
        ...
        <li className= "  md:p-4 shadow-lg hover:text-red-400"><Link to='/sport'><HiTrophy className="sm: h-8 pl-1 mt-2  pb-2 md:h-24" size={45}/></Link></li>
        <li className=" md:p-4 shadow-lg hover:text-red-400"><Link to='/tech'><RiComputerFill className="sm: h-8 pl-1 mt-2 pb-2  md:h-24" size={45}/></Link></li>
      </ul>
    </div>
  );
};
